	...
	echo '<div class="wm_card_big_body">
			<div class="wm_card_body" id="wmCardBody">
				...
				<div class="wm_card_cardmix_input_body" id="wmCardMixInputBody">
					<input type="text" name="uid" class="wm_card_uid_cardmix" id="wmCardMixInput" placeholder="请先输入uid查询卡牌" />
				</div>
				...
				<div class="wm_card_guesscard_input_body" id="wmGuesscardInputBody">
					<input type="text" name="uid" class="wm_card_uid_guesscard" id="wmGuesscardInput" placeholder="请先输入uid查询结果" />
				</div>
				...
				<div class="wm_card_bouerse_input_body" id="wmBouerseInputBody">
					<input type="text" name="uid" class="wm_card_uid_bouerse" id="wmBouerseInput" placeholder="请先输入uid查询股市" />
				</div>
				...
				<div class="wm_card_demining_body" id="wmDeminingBody">
					...
					<div class="wm_card_demining_input_body" id="wmDeminingInputBody">
						<input type="text" name="uid" class="wm_card_uid_demining" id="wmDeminingInput" placeholder="请先输入uid然后挖掘星星" />
				...
				<div class="wm_card_uid_body" id="wmCardChioseInputBody">
				<input type="text" name="uid" class="wm_card_uid" id="wm_card_uid" placeholder="请先输入uid再点击卡片">
				<div class="wm_card_remember_body">
					<div class="wm_card_remember_box" title="公共场合慎用！" id="wmRememberuid">抽卡并保存uid</div>
				</div>
				</div>
